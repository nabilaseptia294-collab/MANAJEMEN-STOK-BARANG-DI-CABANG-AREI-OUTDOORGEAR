...
<body>
            ...
            <div class="layout" style="margin-top: 10px; gap: 20px;">
                <div class="card">
                    <div class="action-buttons" style="padding: 20px">
                        <a style="text-decoration: none;font-size: 14px;" href="{{ route('permintaan.create') }}" class="btn-action">+ Buat Permintaan</button>
                        <a style="text-decoration: none;font-size: 14px;" href="/penerimaan/tambah" class="btn-action">+ Tambah Penerimaan</a>
                        <button class="btn-action">Pengelolaan Stok</button>
                    </div>
            ...
            <tbody id="table-penerimaan-body">
                @forelse ($penerimaan as $i => $p)
                    <tr>
                        ...
                        <td class="col-aksi">
                            <div style="display:flex;gap:10px;justify-content:center">
                                <a href="/penerimaan/detail/{{ $p->no_surat_jalan }}" style="background:none;border:none;cursor:pointer;text-decoration:none">
                                   <p style="color:#000;font-size:14px;padding:6px;padding-left:14px;padding-right:14px;background:{{ $p->status == 'draft' ? '#F7F98A' : '#97EF94' }};border-radius:5px">
                                        {{ $p->status == 'draft' ? 'Draft' : 'Detail' }}
                                    </p>
                                </button>
                                <a href="/penerimaan/edit/{{ $p->no_surat_jalan }}" style="text-decoration:none;cursor:pointer">
                                    <img src="{{ asset('images/pencil-icon.png') }}" width="20">
                                </a>
                                <a onclick="hapusPenerimaan({{ $p->id_penerimaan }})" style="text-decoration:none;cursor:pointer">
                                    <img src="{{ asset('images/trash-icon.png') }}" width="20">
                                </a>
                            </div>
                        </td>
    ...
    <script>
        ...
        function hapusPenerimaan(penerimaanId) {
